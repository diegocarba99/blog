...
{% raw %}<img src="{{ site.url }}{{ site.baseurl }}/assets/images/b001/001_network_adapter_NAT.png" alt="">{% endraw %}
...
{% raw %}<img src="{{ site.url }}{{ site.baseurl }}/assets/images/b001/002_port_rule.png" alt="">{% endraw %}
